...
-- ----------------------------
-- Procedure structure for ACTUALIZAR_PAGOS
-- ----------------------------
...
-- ----------------------------
-- Function structure for generar_nss
-- ----------------------------
DROP FUNCTION IF EXISTS `generar_nss`;
delimiter ;;
...
-- ----------------------------
DROP TRIGGER IF EXISTS `actualizar_pacientes_cascade`;
delimiter ;;
CREATE TRIGGER `actualizar_pacientes_cascade` AFTER UPDATE ON `pacientes` FOR EACH ROW BEGIN
...
-- Triggers structure for table pacientes
-- ----------------------------
DROP TRIGGER IF EXISTS `borrar_pacientes_cascade`;
delimiter ;;
CREATE TRIGGER `borrar_pacientes_cascade` AFTER DELETE ON `pacientes` FOR EACH ROW BEGIN
